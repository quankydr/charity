<script src="<?php echo site_url('assets/js/pages/profile.js')?>"></script>
        ...
        <section class="content">
            <div class="col-md-8 col-md-push-2">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" method="post" id="editFormAvatar" enctype="multipart/form-data" action="<?php echo site_url('admin/upload/doUpload/');?>">
                    <div class="form-group">
